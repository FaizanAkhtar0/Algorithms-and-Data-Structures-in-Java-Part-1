...
//        if (!trieNode.isLeaf()) return false; // -> used when we want the whole word to be checked instead of a part of it.
...
//        if (!trieNode.isLeaf()) return null; // -> used when we want the whole word to be checked instead of a part of it.
    ...
    public String longestCommonPrefix(){
        ...
        while (countNumOfChildren(trieNode) == 1 && !trieNode.isLeaf()){
            ...
            lop = lop + String.valueOf((char) (indexOfSingleChild + 'a'));
        }
